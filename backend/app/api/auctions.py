...
def search_auctions(
    ...
    try:
        ...
        raise HTTPException(
            status_code=502, detail="Failed to fetch auctions from BuyWander."
        )
...
def auction_detail(
    ...
    try:
        ...
        raise HTTPException(
            status_code=502, detail="Failed to fetch auction detail from BuyWander."
        )
...
def list_locations(
    ...
    try:
        ...
        raise HTTPException(
            status_code=502, detail="Failed to fetch store locations from BuyWander."
        )
